...
```json
"com.hungnt.database": "https://github.com/HungNT-UPM/com.hungnt.database.git#v1.0.3"
```

**Phụ thuộc:** `com.hungnt.core`, **Odin Inspector** (inspector + demo tables).
